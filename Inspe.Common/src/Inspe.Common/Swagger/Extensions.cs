...
namespace Inspe.Common.Swagger
{
    public static class Extensions
    {
        /// <summary>
        ///     Add and configure Swagger service in DI
        /// </summary>
        ...
        /// <summary>
        ///     Use Swagger service in an application request pipeline
        /// </summary>
        ...
        public static IApplicationBuilder UseSwaggerDocs(this IApplicationBuilder builder)
        {
            ...
            string routePrefix = string.IsNullOrWhiteSpace(options.RoutePrefix) ? "swagger" : options.RoutePrefix;
