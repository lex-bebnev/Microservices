...
namespace Inspe.Common.Handlers
{
	public class Handler : IHandler
	{
        ...
        private Func<InspeException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<InspeException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (InspeException customException)
            {
                isFailure = true;
